...
do
  ...
  -- lazydev: Lua LSP for your Neovim config
  ...
  local servers = {
    ...
    csharp_ls = {
      root_dir = function()
        ...
        if #files == 0 then files = vim.fn.glob('*.csproj', true, true) end
        if #files == 1 then return vim.fn.fnamemodify(files[1], ':p:h') end
...
-- Neo-tree, indent-blankline, autopairs, lint, debug
-- ============================================================
do
  ...
  -- Indent blankline: add indentation guides
